...
const createGalleryTemplate = (imageInfo) =>
...
const imageInLink = document.querySelectorAll(".gallery-image");
...
galleryListEl.addEventListener("click", (event) => {
  ...
  if (event.target.dataset.source) {
    basicLightbox
      .create(
        `<img src="${event.target.dataset.source}" alt="${event.target.dataset.source}"/>`
      )
      .show();
  }
});
